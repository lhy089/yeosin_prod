      ...
      <section class="provision">
        ...
        <div>
          ...
          <div class="content">
            ...
            2. "회원"이란 본 약관에 따라 회원으로 가입하여 “자격인증센터”가 제공하는 서비스를 받는 개인 및 법인 또는 법인에 준하는 단체를 말합니다.<br/>
            ...
            ③ 본 약관을 개정할 경우 자격인증센터는 이를 홈페이지에 공지하는 방법으로 회원에 대한 약관개정 통지를 갈음할 수 있습니다.<br/>
            ④ 자격인증센터가 본 약관을 개정할 경우에는 그 개정약관은 개정된 내용이 관계 법령에 위배되지 않는 한 개정 이전 가입 회원에게도 적용됩니다.<br/>
            ⑤ 변경된 약관에 이의가 있는 회원은 제6조 제1항에 따라 탈퇴할 수 있습니다.<br/><br/>

            제4조(약관의 적용)<br/>
            본 약관은 자격인증센터가 제공하는 각종 서비스 이용에 관하여 적용하되, 본 약관에 명시되지 아니한 사항에 대해서는 관계법령 및 개별서비스에 관한 이용약관을 적용합니다.<br/><br/>
            ...
            ① 자격인증센터는 관계법령이 정하는 바에 따라서 회원의 개인정보를 보호하기 위하여 노력합니다. 회원의 개인정보 보호에 관해서는 관계법령 및 자격인증센터가 정하는 "개인정보처리방침"에 정한 바에 의합니다.<br/>
            ...
            &nbsp;&nbsp;3. 자격인증 평가 원서접수 및 관리  4. 기타 자격인증과 관련한 서비스<br/>
            ...
            ② 자격인증센터는 관계 법령에 의한 기관의 요청이 있는 경우 회원의 개인정보를 제공할 수 있습니다.<br/><br/>
            ...
            ③ 회원은 자신의 ID와 비밀번호를 유지 및 관리할 책임이 있으며, 자신의 ID와 비밀번호를 보안성 있게 유지 및 관리하지 못하여 발생하는 모든 결과에 대해 전적인 책임이 있습니다. 또한 자신의 ID와 비밀번호가 자신의 승낙없이 사용되었을 경우 즉시 자격인증센터에 통보하여야 하고, 자격인증센터의 안내가 있는 경우에는 그에 따라야 합니다. 또한 다른 회원의 ID를 도용하는 행위를 할 수 없습니다.<br/>
            ...
            1. 회원이 게재한 정보, 자료, 사실의 정확성, 신뢰성 등 내용에 관한 사항<br/>
            2. 회원의 서비스 자료에 대한 취사선택 또는 이용으로 발생하는 손해 등<br/>
            3. 회원이 서비스를 이용하여 기대하는 손익이나 서비스를 통하여 얻은 자료로 인한 손해<br/>
            4. 회원 상호간 또는 회원과 제3자 상호간에 서비스를 매개로 발생한 분쟁<br/>
            5. 회원의 귀책사유로 인한 서비스 이용의 장애<br/>
            ② 회원은 메뉴에서 이루어지는 각종 상담코너를 이용할 수 있으나, 자격인증센터는 위 상담코너의 답변을 근거로 한 제반 소송의 결과에 대해서는 책임을 지지 않습니다.<br/>
            ...
            제17조(법률의 적용)<br/>
            서비스 이용에 관한 분쟁으로 발생되는 모든 법적인 문제는 대한민국의 관계법령의 적용을 받습니다.
          </div>
        </div>
        <div>
          ...
          <div class="content">
            ...
            ② (사)한국여신전문금융업협회 대출성 상품 모집인 자격인증센터(이하 “자격인증센터”)는 모든 개인정보를 중요시하며, 「개인정보 보호법」, 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」 등 관련 법령을 준수합니다.<br/>
            ...
            2. 처리하는 개인정보 항목<br/>
            자격인증센터는 홈페이지를 통해 각종 서비스의 제공을 위해 필요한 최소한의 개인정보만을 처리하고 있습니다. 수집하는 개인정보는 아래와 같습니다.<br/>
            &nbsp;&nbsp;◎ 개인정보 수집항목<br/>
            &nbsp;&nbsp;&nbsp;&nbsp;- 자격인증센터는 각종 서비스의 제공을 위해 아래와 같은 개인정보를 처리하고 있습니다.<br/>
            ...
            3. 개인정보 수집 및 이용목적<br/>
            자격인증센터는 다음과 같은 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.<br/>
            ...
            <strong class="rawBold">① 자격인증센터는 회원 가입일로부터 서비스를 제공하는 기간 동안에 한하여 이용자의 개인정보를 보유 및 이용합니다. 회원탈퇴를 요청하거나, 수집 및 이용목적이 달성 및 이용기간이 종료한 경우 해당 개인정보를 지체없이 파기합니다.<br/>
            ② 정보주체로부터 동의받은 개인정보 보유기간이 경과하거나 처리목적이 달성되었음에도 불구하고 다음 각 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보를 별도의 데이터베이스로 옮기거나 보관장소를 달리하여 보존합니다.<br/>
            ...
            &nbsp;&nbsp;• 개인정보처리자의 안정성 확보<br/>
            &nbsp;&nbsp;&nbsp;&nbsp;- 자격인증센터는 개인정보의 취급 직원을 최소한으로 제한하고 관련 직원들에 대한 수시 교육을 통하여 본 지침을 철저히 준수케 하고 있으며, 본 지침을 조금이라도 위반하는 사항이 발견될 경우 지체 없이 시정조치를 취합니다.
          </div>
        </div>
        <div>
          ...
          <div class="content">
            ...
            ② 자격인증센터는 다음의 기관 및 자에게 개인정보를 제공하고 있으며, 제공목적 및 범위는 다음과 같습니다.</br></br>
            <table class="lawTable">
              <colgroup>
                <col width="35%">
                <col width="35%">
            ...
            <table class="lawTable">
              <colgroup>
                ...
                <col width="*">
                <tr>
                  <th class="rawBold">위탁받는 자(수탁자)</th>
            ...
            ② 자격인증센터는 위탁계약 체결 시 「개인정보 보호법」 제26조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적·관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리·감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자를 개인정보를 안전하게 처리하는지를 감독하고 있습니다.</br>
            ③ 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.</br></br>

            3. 이용자 및 법정대리인의 권리·의무 및 그 행사방법</br>
            ...
            5. 개인정보보호 담당부서</br>
            ① 자격인증센터는 개인정보 처리와 관련한 정보주체의 불만처리·피해구제 및 정보주체의 「개인정보 보호법」 제35조에 따른 개인정보의 열람 청구업무 처리를 위하여 아래와 같이 개인정보보호 담당부서를 지정하고 있습니다. 개인정보보호방침에 관하여 궁금한 사항은 아래의 연락처로 연락하여 주시기 바랍니다.</br>
            <table class="lawTable">
              <colgroup>
                <col width="50%">
                <col width="*">
