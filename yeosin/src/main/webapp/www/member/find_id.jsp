  ...
  <div class="contentBox">
    ...
    <div class="choice">
      ...
      <ul>
        ...
        <!-- 이름,생년월일,성별로 찾기// -->
        <li>
          <h4><a href="#none">이름 / 생년월일 / 성별로 찾기</a></h4>
          <div class="proveBox">
            ...
            <table>
              ...
              <tr>
                <th>성별</th>
                <td>
                  <label class="idType"><input type="radio" name="idType" value="" checked="checked"><span>남자</span></label>
                  <label class="idType"><input type="radio" name="idType" value=""><span>여자</span></label>
                </td>
              </tr>
            </table>
            <a href="#none" class="btn_apply center">확인</a>
          </div>
        </li>
        <!-- //이름,생년월일,성별로 찾기 -->
      </ul>
