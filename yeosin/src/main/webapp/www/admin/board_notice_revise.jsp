...
<div class="board">
  <div class="contentBoxAd">
    ...
    <table>
      ...
      <tr>
        <th>내용</th>
        <td><textarea id="contents" name="contents" placeholder="" rows="8" cols="50">${notice.contents}</textarea></td>
      </tr>
      <tr>
        <th>첨부파일</th>
        <td class="info">
          <input type="text" name="inputFileName" id="inputFileName" class="upload-name" value="${fileName}" disabled="disabled">
    ...
    <div class="btn_apWrap mb100">
       ...
       <a href="/boardNotice?page=${boardDto.page}&boardType=1" class="btn_apply">뒤로가기</a>
    </div>
  </div>
</div>
</form>
