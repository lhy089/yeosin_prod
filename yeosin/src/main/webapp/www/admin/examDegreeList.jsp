...
<div class="manage schedule">
  <div class="contentBoxAd">
	...
	<form action="/excelDownload" method="POST" name="excelForm" id="excelForm">
		<input type="hidden" name="menuId" id="menuId" value="examDegreeList">
	...
	<ul class="btn-group pagination">
	 <c:if test="${pageMaker.prev}">
	     <li>
	        <a href='<c:url value="/manageExamDegreeList?page=${pageMaker.startPage-1}&yearCondition=${yearCondition}&examNameCondition=${examNameCondition}&degreeCondition=${degreeCondition}&onePageDataCountCondition=${pageCondition}" />'><i class="fa fa-chevron-left">이전</i></a>
	    </li>
	</c:if>
	 <c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
	   <li value="${pageNum}"> 
	         <a href='<c:url value="/manageExamDegreeList?page=${pageNum}&yearCondition=${yearCondition}&examNameCondition=${examNameCondition}&degreeCondition=${degreeCondition}&onePageDataCountCondition=${pageCondition}" />'><i class="fa">${pageNum}</i></a>
	   </li>
	</c:forEach>
	<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
	   <li>
	        <a href='<c:url value="/manageExamDegreeList?page=${pageMaker.endPage+1}&yearCondition=${yearCondition}&examNameCondition=${examNameCondition}&degreeCondition=${degreeCondition}&onePageDataCountCondition=${pageCondition}"/>'><i class="fa fa-chevron-right">다음</i></a>
	     </li>
	</c:if>
	</ul>   
