...
<form action="/siteRegisterSave" method="get">
	<div class="site register">
	  <div class="contentBoxAd">
	    <h1 class="title">고사장설정</h1>
    	<input type="hidden" value="<%=request.getParameter("examZoneId")%>" id="examZoneId"/>
	    <h2 id="screenTitle">
   		<!-- 고사장 등록 or 고사장 수정 -->
		</h2>
	    <table class="list">
	...
	<!--         <th>지역</th>
	        ...
	        <th>지역</th>
	        <td><input type="text" name="" value="${examZone.local}"></td>
	      </tr>
	      <tr>
	<!--         <th>구</th>
	        <td>
	        ...
	        <th>구</th>
	        <td><input type="text" name="" value="${examZone.localDetail}"></td>
	      </tr>
	      <tr>
	        <th>고사장명</th>
	        <td><input type="text" name="" value="${examZone.examZoneName}"></td>
	      </tr>
	      <tr>
	        <th>시험 교실 수</th>
	        <td><input type="number" name="" value="${examZone.examRoomCnt}"></td>
	      </tr>
	      <tr>
	        <th>교실당 인원 수</th>
	        <td><input type="number" name="" value="${examZone.examRoomUserCnt}"></td>
	      </tr>
	      <tr>
	        <th>주소</th>
	        <td><input type="text" name="" value="${examZone.description}"></td>
	      </tr>
	      <tr>
	        <th>약도 등록</th>
...
<!-- 	    <a href="#" class="btn_apply mb100">저장</a> -->
	  </div>
	</div>
	<input type="hidden" name="" value="${examZone.examZoneId}">
</form>
