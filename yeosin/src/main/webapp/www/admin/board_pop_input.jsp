...
<div class="board">
  <div class="contentBoxAd">
    ...
    <table>
      ...
      <tr>
        <th>팝업제목</th>
        <td><input type="text" id="title" name="title" placeholder="제목명"></td>
      </tr>
      <tr>
        <th>시작일시</th>
        <td class="popDate">
          <input type="date" id="startDate" name="startDate" value="" class="startDate">
      ...
      <tr>
        <th>종료일시</th>
        <td class="popDate">
          <input type="date" id="endDate" name="endDate" value="" class="endDate">
...
<!--       <tr>
    ...
    <a href="/PopupList" onclick="return doPopupSave()" class="btn_apply mb100">등록</a>
  </div>
</div>
</form>
