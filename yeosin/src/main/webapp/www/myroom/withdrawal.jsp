...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/myroom/withdrawal.js?t=<%= new java.util.Date() %>"></script>
  <script>
  </script>
</head>
...
<%--     <p class="userID">회원탈퇴 ID : <span>${userId}</span></p> --%>
    ...
    <div class="announcement">
      <p>사용하고 계신 아이디로 탈퇴 후 다시 가입할 수 없으며,<br/>다시 가입하시더라도 기존 자격정보는 복구할 수 없습니다.<br/>※ 탈퇴 후 수료증 또는 자격인증서 발급 불가</p>
