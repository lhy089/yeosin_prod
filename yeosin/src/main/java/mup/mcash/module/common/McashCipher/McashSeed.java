...
public class McashSeed implements Serializable {
   ...
   private static void SeedRound(int[] L0, int[] L1, int[] R0, int[] R1, int[] K) {
      ...
      int T1 = R1[0] ^ K[1];
      T1 ^= T0;
      T00 = T0 < 0 ? (long)(T0 & Integer.MAX_VALUE) | -2147483648L : (long)T0;
      T1 = SS0[GetB0(T1)] ^ SS1[GetB1(T1)] ^ SS2[GetB2(T1)] ^ SS3[GetB3(T1)];
      T11 = T1 < 0 ? (long)(T1 & Integer.MAX_VALUE) | -2147483648L : (long)T1;
      T00 += T11;
